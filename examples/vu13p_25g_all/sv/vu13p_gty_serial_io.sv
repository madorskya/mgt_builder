...
(
	...
	assign_mgt_gty_rx ari24 (mgt_gty_rx_if [6][1], p25g_rx [24]);
	assign_mgt_gty_tx ati24 (mgt_gty_tx_if [6][1], p25g_tx [24]);
	assign_mgt_gty_rx ari25 (mgt_gty_rx_if [6][2], p25g_rx [25]);
	assign_mgt_gty_tx ati25 (mgt_gty_tx_if [6][2], p25g_tx [25]);
	assign_mgt_gty_rx ari26 (mgt_gty_rx_if [6][3], p25g_rx [26]);
	assign_mgt_gty_tx ati26 (mgt_gty_tx_if [6][3], p25g_tx [26]);
	assign_mgt_gty_rx ari27 (mgt_gty_rx_if [7][0], p25g_rx [27]);
	assign_mgt_gty_tx ati27 (mgt_gty_tx_if [7][0], p25g_tx [27]);
	assign_mgt_gty_rx ari28 (mgt_gty_rx_if [7][1], p25g_rx [28]);
	assign_mgt_gty_tx ati28 (mgt_gty_tx_if [7][1], p25g_tx [28]);
	...
	assign com_gtrefclk00 [6] = refclk [6]; // p25g_tx 26
	...
	pr25g_mmcm pr25g_6_inst (.O(pr25g_6_mmcm_clk), .I(mgt_gty_tx_if[6][1].txoutclk));
	assign mgt_txusrclk[6][1] = pr25g_6_mmcm_clk; // p25g_tx24
	assign mgt_txusrclk[6][2] = pr25g_6_mmcm_clk; // p25g_tx25
	assign mgt_txusrclk[6][3] = pr25g_6_mmcm_clk; // p25g_tx26
	pr25g_mmcm pr25g_7_inst (.O(pr25g_7_mmcm_clk), .I(mgt_gty_tx_if[7][0].txoutclk));
	assign mgt_txusrclk[7][0] = pr25g_7_mmcm_clk; // p25g_tx27
	assign mgt_txusrclk[7][1] = pr25g_7_mmcm_clk; // p25g_tx28
