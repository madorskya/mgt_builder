...
(
	...
	CPPF_mmcm CPPF_3_inst (.O(CPPF_3_mmcm_clk), .I(mgt_tx_if[18][0].txoutclk));
	assign mgt_txusrclk[18][0] = CPPF_3_mmcm_clk; // gmt_tx1
	DAQ_mmcm DAQ_0_inst (.O(DAQ_0_mmcm_clk), .I(mgt_tx_if[10][0].txoutclk));
	assign mgt_txusrclk[10][0] = DAQ_0_mmcm_clk; // daq_tx0
	CPPF_mmcm CPPF_7_inst (.O(CPPF_7_mmcm_clk), .I(mgt_tx_if[6][3].txoutclk));
