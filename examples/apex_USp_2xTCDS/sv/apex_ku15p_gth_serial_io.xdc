...
set_property LOC GTHE4_CHANNEL_X0Y4  [get_cells */quad_loop[ 0].GTHE4_QUAD_inst/mgt_loop[ 0].GTHE4_CHANNEL_tux_inst/GTHE4_CHANNEL_inst];
set_property LOC GTHE4_CHANNEL_X0Y5  [get_cells */quad_loop[ 0].GTHE4_QUAD_inst/mgt_loop[ 1].GTHE4_CHANNEL_tux_inst/GTHE4_CHANNEL_inst];
create_clock -period 3.100 -name rxclk0_4 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[0]*mgt_loop[0]*GTHE4_CHANNEL_inst*}]]; # tcds_rx0
create_clock -period 3.100 -name txclk0_5 [get_pins -filter {REF_PIN_NAME=~*TXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[0]*mgt_loop[1]*GTHE4_CHANNEL_inst*}]]; # tcds_tx0
