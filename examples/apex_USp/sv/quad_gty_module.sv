...
(
	...
	bufg_gt_tux (.O(mgt_rxusrclk[0]), .I(mgt_gty_rx_if[0].rxoutclk));
	bufg_gt_tux (.O(mgt_rxusrclk[1]), .I(mgt_gty_rx_if[1].rxoutclk));
	bufg_gt_tux (.O(mgt_rxusrclk[2]), .I(mgt_gty_rx_if[2].rxoutclk));
	bufg_gt_tux (.O(mgt_rxusrclk[3]), .I(mgt_gty_rx_if[3].rxoutclk));
